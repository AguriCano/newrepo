...
ALTER TYPE public.account_type OWNER TO cse340_926o_user;
...
-- ADDITIONAL ENHANCEMENT: Vehicle Reviews
CREATE TABLE IF NOT EXISTS public.review (
  ...
  review_created timestamp DEFAULT now() NOT NULL,
  review_verified_purchase boolean DEFAULT false NOT NULL,
  CONSTRAINT review_pkey PRIMARY KEY (review_id),
  CONSTRAINT review_inv_fkey FOREIGN KEY (review_inv_id) REFERENCES public.inventory (inv_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT review_account_fkey FOREIGN KEY (review_account_id) REFERENCES public.account (account_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE
);